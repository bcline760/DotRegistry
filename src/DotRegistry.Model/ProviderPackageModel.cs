...
namespace DotRegistry.Model
{
    ...
    /// 
    /// </summary>
    public class ProviderPackageModel : ProviderModel
    {
        public ProviderPackageModel()
        {

        }

        /// <summary>
        /// Construct a new package model
        /// </summary>
        public ProviderPackageModel(ProviderPackage package) : base(package)
        {
            Active = package.Active;
            Architecture = package.Architecture;
            DownloadUrl = package.DownloadUrl.AbsoluteUri;
            Filename = package.Filename;
            OperatingSystem = package.OperatingSystem;
            ShaSum = package.Shasum;
            ShaSumSignatureUrl = package.ShasumsSignatureUrl.AbsoluteUri;
            ShaSumUrl = package.ShasumsUrl.AbsoluteUri;
            Version = package.ProviderVersion;

            SigningKey = new SigningKeyModel(package.SigningKeys);
        }
